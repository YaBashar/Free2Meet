...
import { EventError } from "./service/event.service";
import { AttendeeError } from "./service/attendee.service";
// set up app
...
app.use((err: unknown, _req: Request, res: Response, _next: NextFunction) => {
  if (err instanceof AuthError || err instanceof EventError || err instanceof AttendeeError) {
